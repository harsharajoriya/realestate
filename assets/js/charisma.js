$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://103.9.171.244/~jimeleco/jimele/jadmin/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://103.9.171.244/~jimeleco/jimele/jadmin/css/bootstrap-' + themeName + '.min.css');
        }
